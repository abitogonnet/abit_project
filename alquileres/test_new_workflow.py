...
class NewWorkflowTests(TestCase):
    ...
    def test_creacion_real_crea_cliente_y_recurrente_muestra_aviso(self):
        ...
        self.assertRedirects(response, reverse("alquileres:crear"))
        self.assertEqual(Cliente.objects.count(), 1)
        ...
        response = self.client.post(reverse("alquileres:crear"), self.create_payload(segunda, cliente_nombre="Juan Manuel Pérez"), follow=True)
